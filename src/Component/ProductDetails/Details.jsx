        ...
        <div className="container pt-28 ">
            ...
            <div className="col-span-3   flex flex-col items-center justify-center  gap-4">
                    ...
                    <div className="w-2/3">
                            ...
                            <img src={details.image} alt="Image" className="rounded-md  w-full object-cover" />
                ...
                <div className="col-span-3 flex flex-col justify-center">
                    ...
                    <div className="flex flex-col  justify-center gap-4" >
                        <p className="mt-4 text-orange-500 font-bold text-xl">${details.price}</p>
                        ...
                        <div>
                            <h2 className="capitalize font-goldman font-medium ">description & fit</h2>
                                <p className="text-gray-600 leading-normal mt-2 font-poppins text-sm">{details.description}</p>
                            </div>
